Continue from [last week](http://qingkaikong.blogspot.com/2018/01/learning-qgis-import-data-and-change.html), we have the population and earthquake data in QGIS, which looks like the following:
